...
namespace DougKlassen.Pegboard.Commands
{
    ...
    internal class SplitWallByLevelCommand : IExternalCommand
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            //TODO: logic of command needs a complete review. Failing to correctly split walls
            ...
            if (result)
            {
                hostLevels = levelPickerWindow.ElementsToChoose
                    .Cast<Level>()
                    .OrderBy(l => l.Elevation)
                    .ToList();
