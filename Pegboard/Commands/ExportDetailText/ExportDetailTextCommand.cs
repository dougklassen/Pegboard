...
namespace DougKlassen.Pegboard.Commands
{
    ...
    internal class ExportDetailTextCommand : IExternalCommand
    {
        //TODO: this currently doesn't export as a valid CSV because it includes EOL in the Revit detail text
