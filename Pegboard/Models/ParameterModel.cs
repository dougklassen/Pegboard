...
namespace DougKlassen.Pegboard.Models
{
    internal class ParameterModel
    {
        ...
        public String group;
        /// <summary>
        /// If the parameter is a measurable quantity, the type of quantity that it measures 
        /// Formerly, the value corresponding to LabelUtils.GetLabelFor(def.ParameterType)
        /// Now, the label of the ForgeTypeId of the parameter's data type
        ...
        /// <summary>
        /// Construct a ParameterModel based on a BuiltInParameter Enum value. This only retrieves partial information
        /// for the parameter because it doesn't have access to the Parameter Definition.
        /// </summary>
        ...
        {
            name = def.Name;
            group = LabelUtils.GetLabelForGroup(def.GetGroupTypeId());
            ...
            if (b is ElementBinding)
            {
                ...
                {
                    categories.Add(cat.Id.Value);
                }
            }
        }

        /// <summary>
        /// Construct a ParameterModel based on the Parameter itself 
        /// </summary>
